...
public interface BookingRepository extends JpaRepository<Booking, Long> {
    ...
    Page<Booking> findAllByItemOwnerIdAndStartIsAfter(Long owner, LocalDateTime time, Pageable pageable);//future
    ...
    Page<Booking> findAllByItemOwnerIdAndEndIsBeforeOrderByStartDesc(Long owner, LocalDateTime time, Pageable pageable);//past
}